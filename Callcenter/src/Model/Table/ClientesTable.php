...
class ClientesTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('telfconvencional')
            ->maxLength('telfconvencional', 45)
            ->requirePresence('telfconvencional', 'create')
            ->notEmptyString('telfconvencional');

        $validator
            ->scalar('telfmovil')
            ->maxLength('telfmovil', 45)
            ->requirePresence('telfmovil', 'create')
            ->notEmptyString('telfmovil');
    ...
    {
        $rules->add($rules->existsIn(['ciudade_id'], 'Ciudades'), ['errorField' => 'ciudade_id']);
